...
class MenuScene:
    def __init__(self, app):
        ...
        self.records_button = Button(self.app.screen, self.app.screen.get_width() // 2, self.app.screen.get_height() // 3 + 50,
                                     'Records', self.app.font, on_press=None)
        self.exit_button = Button(self.app.screen, self.app.screen.get_width() // 2, self.app.screen.get_height() // 3 + 100,
                                  'Exit', self.app.font, on_press=self.exit)
